...
# ``r package_name`` <img src='https://i.imgur.com/m7lDBGD.png' align="right" height="50"/>
...
```{r project-data-model, out.width = "100%", fig.height=0.5, echo = FALSE, message=FALSE, eval = FALSE}
ds$data_model %>% 
  dm::cdm_draw(
